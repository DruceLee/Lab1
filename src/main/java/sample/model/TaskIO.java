...
public class TaskIO {
    ...
    public static void writeBinary(TaskList tasks, File file) throws IOException {
        try {
            ...
            logger.error("Файл небыл найден при вызове метода writeBinary");
        }
    }
    ...
    public static void readBinary(TaskList tasks, File file)  throws IOException, ClassNotFoundException, TaskException {
        try {
            ...
            logger.error("Файл небыл найден при вызове метода readBinary");
        }
    }
    ...
    public static void readText(TaskList tasks, File file) {
        try {
            ...
            logger.error("Файл небыл найден при вызове метода readText");
        } catch (IOException e) {
            logger.error("IOException в методе readText");
        } catch (TaskException e) {
            logger.error("Ошибка при записи поля title (null) в методе readText");
        }
